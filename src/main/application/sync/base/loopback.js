  ...
  responseHTML() {
    return `<!DOCTYPE html>
      <html lang="en">
        ...
        <body>
          <div class="message"><h2>You’ve successfully connected!</h2><p>You may now close this window and proceed to password manager app.</p></div>
        </body>
      </html>
    `
  }
