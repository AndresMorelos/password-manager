...
export default class GDrive {
  constructor(cryptor) {
    ...
    this.folderName = 'PasswordManager'
  ...
  async readRemoteVault() {
    ...
    if (!folderId) throw Error('PasswordManager folder was not found on GDrive')
  ...
  async createRemoteVault(data) {
    ...
    if (!folderId) throw Error('Failed to create PasswordManager folder on GDrive')
